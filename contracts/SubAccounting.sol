...
contract SubAccounting is Accounting {
    ...
    function depositETH(
        SuperAccount storage superAcc,
        bytes32 _subKey,
        address _from,
        uint256 _value
    ) internal {
        depositETH(superAcc.base, _from, _value);
        superAcc.subAccounts[_subKey].balanceETH = superAcc
            .subAccounts[_subKey]
            .balanceETH
            .add(_value);
    }
    ...
    function depositToken(
        ...
        superAcc.subAccounts[_subKey].tokenBalances[_token] = superAcc
            .subAccounts[_subKey]
            .tokenBalances[_token]
            .add(_value);
    ...
    function transferETH(
        ...
        require(
            _from.subAccounts[_fromKey].balanceETH >= _value,
            "Insufficient ETH balance in account!"
        );
        transferETH(_from.base, _to.base, _value);
        _from.subAccounts[_fromKey].balanceETH = _from
            .subAccounts[_fromKey]
            .balanceETH
            .sub(_value);
        _to.subAccounts[_toKey].balanceETH = _to
            .subAccounts[_toKey]
            .balanceETH
            .add(_value);
    }
    ...
    function transferETH(
        ...
        require(
            _superAcc.subAccounts[_fromKey].balanceETH >= _value,
            "Insufficient ETH balance in account!"
        );
        _superAcc.subAccounts[_fromKey].balanceETH = _superAcc
            .subAccounts[_fromKey]
            .balanceETH
            .sub(_value);
        _superAcc.subAccounts[_toKey].balanceETH = _superAcc
            .subAccounts[_toKey]
            .balanceETH
            .add(_value);
    }
    ...
    function sendETH(
        SuperAccount storage a,
        bytes32 _fromKey,
        address payable _to,
        uint256 _value
    ) internal {
        require(
            a.subAccounts[_fromKey].balanceETH >= _value,
            "Insufficient ETH balance in account!"
        );
        a.subAccounts[_fromKey].balanceETH = a
            .subAccounts[_fromKey]
            .balanceETH
            .sub(_value);
    ...
    function transferToken(
        ...
        require(
            _from.subAccounts[_fromKey].tokenBalances[_token] >= _value,
            "Insufficient token balance in account!"
        );
        transferToken(_from.base, _to.base, _token, _value);
        _from.subAccounts[_fromKey].tokenBalances[_token] = _from
            .subAccounts[_fromKey]
            .tokenBalances[_token]
            .sub(_value);
        _to.subAccounts[_toKey].tokenBalances[_token] = _to
            .subAccounts[_toKey]
            .tokenBalances[_token]
            .add(_value);
    }
    ...
    function transferToken(
        ...
        require(
            _superAcc.subAccounts[_fromKey].tokenBalances[_token] >= _value,
            "Insufficient token balance in account!"
        );
        _superAcc.subAccounts[_fromKey].tokenBalances[_token] = _superAcc
            .subAccounts[_fromKey]
            .tokenBalances[_token]
            .sub(_value);
        _superAcc.subAccounts[_toKey].tokenBalances[_token] = _superAcc
            .subAccounts[_toKey]
            .tokenBalances[_token]
            .add(_value);
    }
    ...
    function sendToken(
        ...
        require(
            a.subAccounts[_fromKey].tokenBalances[_token] >= _value,
            "Insufficient token balance in account!"
        );
        a.subAccounts[_fromKey].tokenBalances[_token] = a
            .subAccounts[_fromKey]
            .tokenBalances[_token]
            .sub(_value);
    ...
    function drainToken(
        ...
        transferToken(
            ...
            _to,
            _token,
            _from.base.tokenBalances[_token]
        );
    }
}
